        ...
        if bot_instance and bot_instance.gating:
            ...
            try:
                ...
                enhanced_features['_metadata'] = {
                    ...
                    'pool_candidates': rfe_summary.get('pool_candidates', 0),
                    'must_keep_count': rfe_summary.get('must_keep_count', 0),
                    'final_selected': rfe_summary.get('final_selected', rfe_summary.get('total_selected', 0)),
